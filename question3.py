...
def get_center_block_histogram(image, radius=1, n_points=8 * 1, block_size=(40, 40), center_block=(3, 3), bins=256):
    """
    Extracts the LBP histogram of the specified center region from the image.
    Args:
    ...
    Returns:
    - histogram: The 256-bin histogram for the specified block.
    """
    # Compute LBP
...
# Plot the 256-bin histogram for each center region
fig, axes = plt.subplots(3, 1, figsize=(10, 12))
histograms = [center_histogram1, center_histogram2, center_histogram3]
titles = ["256-bin Histogram for Center Region (3,3) - Image 1", 
          "256-bin Histogram for Center Region (3,3) - Image 2", 
          "256-bin Histogram for Center Region (3,3) - Image 3"]
